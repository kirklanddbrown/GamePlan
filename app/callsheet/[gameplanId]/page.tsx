...
export default function CallSheetBuilder({ params }: { params: { gameplanId: string } }) {
  ...
  const [gamePlan] = useState<GamePlan>({
    ...
    location: params.gameplanId === "1" ? "Home" : "Away",
    weather: "45°F, Clear",
    wind: "5 mph NW",
  })
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Game Call Sheet</CardTitle>
              <CardDescription>
      ...
      <Tabs defaultValue="offense" className="w-full">
        ...
        <TabsContent value="offense" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Personnel Packages vs {gamePlan.opponent}</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            {Object.entries(callSheetData).map(([key, section]) => (
              <Card key={key}>
                <CardHeader>
                  ...
                  <CardDescription>
                    {section.plays.length} plays vs {gamePlan.opponent}
                  </CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <TabsContent value="defense">
          <Card>
            <CardHeader>
              <CardTitle>Defensive Call Sheet vs {gamePlan.opponent}</CardTitle>
        ...
        <TabsContent value="special">
          <Card>
            <CardHeader>
              <CardTitle>Special Teams Call Sheet vs {gamePlan.opponent}</CardTitle>
              <CardDescription>Coming soon...</CardDescription>
            </CardHeader>
          </Card>
        </TabsContent>
