...
import { getOpponentForWeek, getDateForWeekFromStore } from "@/lib/gameplan-store"
...
export default function PracticeScript({ params }: { params: { week: string } }) {
  ...
  // Load game plan data from store
  useEffect(() => {
    const week = Number.parseInt(params.week)
    const opponent = getOpponentForWeek(week)
    const date = getDateForWeekFromStore(week)
    ...
    setPracticePeriods([
      {
        ...
        focus: "Fundamentals",
        plays: [],
        notes: `Focus on proper stance and footwork for Week ${week} vs ${opponent}`,
      },
      {
        id: "2",
        name: "7 on 7",
        ...
        notes: `Work on timing vs ${opponent} Cover 2 defense`,
      },
      {
        id: "3",
        name: "Team Period",
        ...
        notes: `Full speed execution - prepare for ${opponent} front 7`,
      },
    ])
  }, [params.week])
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Week {gamePlan.week} preparation</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={`Additional notes for Week ${gamePlan.week} vs ${gamePlan.opponent}...`}
              />
            </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    {period.duration} minutes • Focus: {period.focus} • Week {gamePlan.week} vs {gamePlan.opponent}
                  </CardDescription>
                </div>
